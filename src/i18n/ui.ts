...
const en = {
  ...
  'header.line1': 'Building software in Prague.',
  'header.line2': 'Open to new opportunities',
  'header.hire': 'Contact me',
...
const cs = {
  ...
  'header.line1': 'Stavím software v Praze.',
  'header.line2': 'Otevřený novým příležitostem',
  'header.hire': 'Napište mi',
